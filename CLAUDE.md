...
| Desktop shell has no "home page" — deselecting always snaps back into a terminal; add a deselectable fleet-overview detail-pane state (client-only, natural host for v3 fleet widgets) | P3 | S | `_docs/issues/2026-07-15-desktop-no-home-page.md` |
