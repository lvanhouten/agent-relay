...
|----|----------|------|---------|--------|
| W1 | WARNING | 55 | ATTENTION map un-extracted/untested; sole vocab sync point | (open) |
| N1 | NOTE | 35 | Unknown-status fallback inverts urgency under version skew | (open) |
